...
export const ChatPreview: React.FC<ChatPreviewProps> = ({ 
  ...
  return (
    <div ref={containerRef} className={containerClasses}>
        ...
        {app === AppType.INSTAGRAM && <InstagramUI messages={messages} themName={themName} themPhoto={themPhoto} />}
        {app === AppType.WHATSAPP && <WhatsAppUI messages={messages} themName={themName} themPhoto={themPhoto} />}
        {app === AppType.TIKTOK && <TikTokUI messages={messages} themName={themName} themPhoto={themPhoto} />}
